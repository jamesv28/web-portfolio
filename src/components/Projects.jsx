    ...
    <div className=" py-20 align-element" id="projects">
      ...
      <div className="py-16 grid gap-8 md:grid-cols-2 ">
        <div>
          ...
          <ul className="text-lg">
            ...
            <li>
              Created a qr code scanner for managing, updating barrel locations
              and updating the status of the whiskey.
            </li>
            <li>
      ...
      <div className="py-16 grid gap-8 md:grid-cols-2 ">
        ...
        <div>
          ...
          <ul className="text-lg">
            ...
            <li>
              Used WCAG guidelines to enhance new and upcoming features with the
              app.
            </li>
      ...
      <div className="py-16 grid gap-8 md:grid-cols-2 ">
        <div>
          ...
          <ul className="text-lg">
            <li>
              Initially began on the mobile team for usability and accessibility
              (iOS & android)
            </li>
            <li>
              On iOS team, began migrating from objective-c to swift programming
              language
            </li>
            <li>
